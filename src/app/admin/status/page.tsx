...
interface ManagedContact {
  id?: number;  // Optional for new contacts, auto-generated by database
  name: string;
  avatar_url: string;
  status_text: string;
...
const StatusManagementPage = () => {
  ...
  const deleteContact = async (contactId: number | undefined, contactName: string) => {
    if (!contactId) return;
  ...
  const addNewContact = () => {
    const newContact: ManagedContact = {
      // No ID - will be auto-generated by database
      name: 'New Contact',
  ...
  const updateContact = (contactId: number | undefined, field: keyof ManagedContact, value: any) => {
