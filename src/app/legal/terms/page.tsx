          ...
          <CardContent className="space-y-4">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Welcome to WhatApp Chat ("the Service"). These Terms of Service ("Terms") govern your use of our
              ...
              <p className="text-muted-foreground mt-2">
                ...
                Interactions are simulated and not with a real human. This is an entertainment service that uses
                advanced AI to create engaging conversations, **with persistent memory and evolving personality based on your interactions.**
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mt-4 mb-2">2. AI Interaction and Data Handling</h2>
              <p className="text-muted-foreground">
                You acknowledge that "Kruthika" is an AI companion and not a real person. The Service is provided for
                entertainment and social interaction purposes. To enable Kruthika's long-term memory, personalization,
                relationship progression, and evolving backstory, **your chat history (including messages, image indicators, and metadata) is stored permanently on our secure Supabase servers.**
                This data is also processed by third-party Generative AI service providers as detailed in our Privacy Policy.
                While the AI is designed to be engaging and personable, do not rely on the AI for professional advice (e.g., medical, legal, financial).
                The responses are generated by artificial intelligence and should be treated as entertainment content.
              </p>
              <p className="text-muted-foreground mt-2">
                **Crucial Advisory:** Due to the persistent storage of chat history, you should specifically **refrain from sharing highly sensitive personal information** (e.g., financial details, government IDs, precise health information, or any information you would not want permanently recorded and processed by an AI system) through the chat interface.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold mt-4 mb-2">4. Content Accuracy and AI Limitations</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                You retain all rights to the User Content you create and share through the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                Upon termination, your right to use the Service will immediately cease. If you wish to terminate your account and request data deletion, please refer to our Privacy Policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                If you have any questions about these Terms, please contact us at [Your Contact Email Address - **PLEASE UPDATE**].
              </p>
            </section>
