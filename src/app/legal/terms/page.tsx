          ...
          <CardContent className="space-y-4">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2">
                ...
                advanced AI to create engaging conversations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                entertainment and social interaction purposes. While the AI is designed to be engaging and personable,
                do not rely on the AI for professional advice (e.g., medical, legal, financial). The responses are
                generated by artificial intelligence and should be treated as entertainment content.
              </p>
            </section>
